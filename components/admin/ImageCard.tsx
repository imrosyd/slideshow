...
export const ImageCard = ({ image, onChange, onReset, onDelete }: Props) => {
  const hasChanges =
  ...
  return (
    <article className={`group flex flex-col gap-5 rounded-3xl border border-white/10 bg-white/5 p-5 text-white shadow-glass transition hover:border-sky-400/50 hover:bg-white/10 ${hasChanges ? "ring-2 ring-sky-400/60" : ""}`}>
